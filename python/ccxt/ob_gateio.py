...
from ccxt.abstract.ob_gateio import ImplicitAPI
from ccxt.base.types import Any, Market, Ticker
from typing import List
from ccxt.base.errors import OBIPWhitelistError


class ob_gateio(gateio, ImplicitAPI):

    def describe(self) -> Any:
        base = super(ob_gateio, self).describe()
    ...
    def handle_errors(self, code: int, reason: str, url: str, method: str, headers: dict, body: str, response, requestHeaders, requestBody):
        ...
        return super(ob_gateio, self).handle_errors(code, reason, url, method, headers, body, response, requestHeaders, requestBody)
    ...
    def parse_ticker(self, ticker: dict, market: Market = None) -> Ticker:
        ...
        parsed = super(ob_gateio, self).parse_ticker(ticker, market)
