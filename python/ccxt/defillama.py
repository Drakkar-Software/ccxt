...
class defillama(Exchange, ImplicitAPI):
    ...
    def fetch_current_prices(self, coinKeys: List[str], params={}) -> dict:
        ...
        response = self.publicGetPricesCurrentCoins(self.extend(request, params))
    ...
    def build_ticker_for_market(self, market: Market, coins: dict) -> Ticker:
        chainSlug = self.get_chain_slug_from_market(market)
        baseId = self.safe_string(market, 'baseId')
        quoteId = self.safe_string(market, 'quoteId')
        baseKey = self.build_coin_key(chainSlug, baseId)
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        coins = self.fetch_current_prices(coinKeys, params)
        ticker = self.build_ticker_for_market(market, coins)
    ...
    def ob_fetch_dex_pairs(self, symbols: List[str], params={}) -> List[ObDexPair]:
        ...
        self.load_markets()
        resolveResult = self.resolve_markets(resolveSymbols, params)
        marketsBySymbol = resolveResult['marketsBySymbol']
