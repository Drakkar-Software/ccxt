...
class coinrabbit(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        response = self.publicGetMarketMarkets(params)
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        response = self.privatePostTradingOrder(self.extend(request, params))
    ...
    def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        response = self.privateGetTradingOrderId(self.extend(request, params))
        orderPayload = self.coinrabbit_unwrap_response(response)
        market = None
    ...
    def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            request['limit'] = limit
        params = self.omit(params, ['base_network', 'baseNetwork', 'quote_network', 'quoteNetwork'])
        response = self.privateGetTradingOrders(self.extend(request, params))
    ...
    def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        openOrders = self.fetch_orders(symbol, since, limit, openParams)
        activeOrders = self.fetch_orders(symbol, since, limit, activeParams)
        ordersById = {}
