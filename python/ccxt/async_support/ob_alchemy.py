...
from ccxt.async_support.alchemy import alchemy
from ccxt.abstract.ob_alchemy import ImplicitAPI
from ccxt.base.types import Any
from typing import List


class ob_alchemy(alchemy, ImplicitAPI):

    def describe(self) -> Any:
        return self.deep_extend(super(ob_alchemy, self).describe(), {
            'id': 'ob_alchemy',
            'name': 'Alchemy',
            'certified': False,
            'urls': {
    ...
    async def ob_load_markets_for_symbols(self, symbols: List[str], reload=False, params={}) -> List[dict]:
        ...
        """
        await super(ob_alchemy, self).ob_load_markets_for_symbols(symbols, reload, params)
