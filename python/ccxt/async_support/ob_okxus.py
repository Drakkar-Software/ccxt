...
from ccxt.abstract.ob_okxus import ImplicitAPI
...
class ob_okxus(okxus, ImplicitAPI):

    def describe(self) -> Any:
        return self.deep_extend(super(ob_okxus, self).describe(), {
            'id': 'ob_okxus',
            'name': 'OKX(US)',
            'certified': False,
            'urls': {
    ...
    def parse_order(self, order: dict, market: Market = None) -> Order:
        ...
        parsed = super(ob_okxus, self).parse_order(order, market)
        ...
        if type != 'market' and type != 'limit':
            ...
            if slTrigger is not None and tpTrigger is not None:
                ...
                self.log('ob_okxus.parseOrder', 'Unsupported OKX OCO(stop loss & take profit in a single order): ' + self.json(parsed))
                updated = 'unsupported'
                ...
                self.log('ob_okxus.parseOrder', 'Unknown ob_okxus order type, order: ' + self.json(parsed))
