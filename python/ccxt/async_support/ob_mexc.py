...
class ob_mexc(mexc, ImplicitAPI):
    ...
    async def fetch_account_id(self, params={}, _ccxtTypesImportStr: Str = None) -> Str:
        try:
            resp = await self.spotPrivateGetUid(params)
    ...
    async def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        return await super(ob_mexc, self).fetch_deposits(code, since, limit, params)
    ...
    async def fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        if since is None:
            ...
            since = now - 6 * 24 * 60 * 60 * 1000
            params = self.extend(params, {'endTime': now})
        return await super(ob_mexc, self).fetch_withdrawals(code, since, limit, params)
