...
from ccxt.async_support.defillama import defillama
from ccxt.abstract.ob_defillama import ImplicitAPI
from ccxt.base.types import Any
from typing import List


class ob_defillama(defillama, ImplicitAPI):

    def describe(self) -> Any:
        return self.deep_extend(super(ob_defillama, self).describe(), {
            'id': 'ob_defillama',
            'name': 'DefiLlama',
            'certified': False,
            'urls': {
    ...
    async def ob_load_markets_for_symbols(self, symbols: List[str], reload=False, params={}) -> List[dict]:
        ...
        """
        await super(ob_defillama, self).ob_load_markets_for_symbols(symbols, reload, params)
