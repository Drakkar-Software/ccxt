...
class ob_coinbase(coinbase, ImplicitAPI):
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        if not ('v3' in params):
            ...
            params['v3'] = True
        return await super(ob_coinbase, self).fetch_balance(params)
        ...
        if normalizedType == 'MARKET':
            ...
            if takeProfitPrice is None:
                ...
                if stopTrigger is not None:
                    ...
                    return await super(ob_coinbase, self).create_order(symbol, 'limit', side, amount, limitPrice, merged)
        return await super(ob_coinbase, self).create_order(symbol, type, side, amount, price, params)
