...
from ccxt.async_support.kucoineu import kucoineu
...
class ob_kucoineu(kucoineu, ImplicitAPI):
 ...
 @param market Parsed spot market structure.
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        markets = await super(ob_kucoineu, self).fetch_markets(params)
        result = []
    ...
    async def fetch_permissions(self, params={}) -> List[str]:
        rights = await self.ob_fetch_permissions_imaginary_cancel('12345', 'BTC/USDT', params, 'pair')
        filteredRights = []
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if effectiveLimit is None:
            ...
            effectiveLimit = 200
        return await super(ob_kucoineu, self).fetch_open_orders(symbol, since, effectiveLimit, params)
    ...
    async def fetch_account_id(self, params={}, _ccxtTypesImportStr: Str = None) -> Str:
        ...
        try:
            ...
            if probingSubaccount is not None:
                subApiKeyResponse = await self.privateGetSubApiKey(self.extend({
