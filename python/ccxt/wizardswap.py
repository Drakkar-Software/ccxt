...
class wizardswap(Exchange, ImplicitAPI):
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        #  ["btc","xmr","eth",...]
        #
        richResponse = self.publicGetCurrency(params)
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        # }
        #
        pairsData = self.publicGetPairs(params)
        result = []
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = self.publicPostEstimate(self.extend(request, params))
        #
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        response = self.publicPostExchange(self.extend(request, params))
    ...
    def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        response = None
        try:
            response = self.publicGetExchangeId(self.extend(request, params))
