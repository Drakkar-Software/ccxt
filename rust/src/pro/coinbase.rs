...
async fn subscribe(&mut self, mut name: Value, mut is_private: Value, mut symbol: Value, mut params: Value) -> Value { Value::Undefined }

async fn un_subscribe(&mut self, mut topic: Value, mut name: Value, mut is_private: Value, mut symbol: Value) -> Value { Value::Undefined }

async fn subscribe_multiple(&mut self, mut name: Value, mut is_private: Value, mut symbols: Value, mut params: Value) -> Value { Value::Undefined }

async fn un_subscribe_multiple(&mut self, mut topic: Value, mut name: Value, mut is_private: Value, mut symbols: Value, mut params: Value) -> Value { Value::Undefined }

fn create_ws_auth(&mut self, mut name: Value, mut product_ids: Value) -> Value { Value::Undefined }
...
fn handle_order_book_helper(&mut self, mut orderbook: Value, mut updates: Value) -> Value { Value::Undefined }

fn handle_order_book(&mut self, mut client: Value, mut message: Value) -> Value { Value::Undefined }

fn try_resolve_usdc(&mut self, mut client: Value, mut message_hash: Value, mut result: Value) -> Value { Value::Undefined }

fn handle_subscription_status(&mut self, mut client: Value, mut message: Value) -> Value { Value::Undefined }

fn handle_heartbeats(&mut self, mut client: Value, mut message: Value) -> Value { Value::Undefined }
