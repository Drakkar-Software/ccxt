...
pub trait Coinbase : Exchange {
    ...
    async fn un_subscribe(&mut self, mut topic: Value, mut name: Value, mut is_private: Value, mut symbol: Value) -> Value {
        self.load_markets(Value::Undefined, Value::Undefined).await;
        if self.safe_bool(self.get("options".into()), Value::from("unSubscriptionPending"), Value::from(false)).is_truthy() {
        ...
        self.get("options".into()).set("unSubscriptionPending".into(), Value::from(true));
        let mut market: Value = Value::Undefined;
        ...
        self.get("options".into()).set("unSubscriptionPending".into(), Value::from(false));
    ...
    fn create_ws_auth(&mut self, mut name: Value, mut product_ids: Value) -> Value {
        ...
        let mut is_cloud_a_pi_key: Value = (self.get("apiKey".into()).index_of(Value::from("organizations/")) >= Value::from(0) || self.get("secret".into()).starts_with(Value::from("-----BEGIN"))).into();
        ...
        if !is_cloud_a_pi_key.is_truthy() {
            ...
            if self.get("apiKey".into()).starts_with(Value::from("-----BEGIN")) {
    ...
    async fn watch_ticker(&mut self, mut symbol: Value, mut params: Value) -> Value {
        ...
        return <Self as Coinbase>::subscribe(self, name.clone(), Value::from(false), symbol.clone(), params.clone()).await;
    }
    ...
    async fn un_watch_ticker(&mut self, mut symbol: Value, mut params: Value) -> Value {
        ...
        self.load_markets(Value::Undefined, Value::Undefined).await;
        let mut name: Value = Value::from("ticker");
        return <Self as Coinbase>::un_subscribe(self, Value::from("ticker"), name.clone(), Value::from(false), symbol.clone()).await;
    }
    ...
    async fn watch_tickers(&mut self, mut symbols: Value, mut params: Value) -> Value {
        ...
        let mut ticker: Value = <Self as Coinbase>::subscribe_multiple(self, name.clone(), Value::from(false), symbols.clone(), params.clone()).await;
    ...
    async fn un_watch_tickers(&mut self, mut symbols: Value, mut params: Value) -> Value {
        ...
        return <Self as Coinbase>::un_subscribe_multiple(self, Value::from("ticker"), Value::from("ticker_batch"), Value::from(false), symbols.clone(), Value::Undefined).await;
    }
    ...
    async fn watch_trades(&mut self, mut symbol: Value, mut since: Value, mut limit: Value, mut params: Value) -> Value {
        ...
        let mut trades: Value = <Self as Coinbase>::subscribe(self, name.clone(), Value::from(false), symbol.clone(), params.clone()).await;
        if self.get("newUpdates".into()).is_truthy() {
    ...
    async fn un_watch_trades(&mut self, mut symbol: Value, mut params: Value) -> Value {
        ...
        self.load_markets(Value::Undefined, Value::Undefined).await;
        let mut name: Value = Value::from("market_trades");
        return <Self as Coinbase>::un_subscribe(self, Value::from("trades"), name.clone(), Value::from(false), symbol.clone()).await;
    }
    ...
    async fn watch_trades_for_symbols(&mut self, mut symbols: Value, mut since: Value, mut limit: Value, mut params: Value) -> Value {
        ...
        self.load_markets(Value::Undefined, Value::Undefined).await;
        let mut name: Value = Value::from("market_trades");
        let mut trades: Value = <Self as Coinbase>::subscribe_multiple(self, name.clone(), Value::from(false), symbols.clone(), params.clone()).await;
        if self.get("newUpdates".into()).is_truthy() {
    ...
    async fn un_watch_trades_for_symbols(&mut self, mut symbols: Value, mut params: Value) -> Value {
        ...
        self.load_markets(Value::Undefined, Value::Undefined).await;
        let mut name: Value = Value::from("market_trades");
        return <Self as Coinbase>::un_subscribe_multiple(self, Value::from("trades"), name.clone(), Value::from(false), symbols.clone(), params.clone()).await;
    }
    ...
    async fn watch_orders(&mut self, mut symbol: Value, mut since: Value, mut limit: Value, mut params: Value) -> Value {
        ...
        let mut orders: Value = <Self as Coinbase>::subscribe(self, name.clone(), Value::from(true), symbol.clone(), params.clone()).await;
        if self.get("newUpdates".into()).is_truthy() {
    ...
    async fn un_watch_orders(&mut self, mut symbol: Value, mut params: Value) -> Value {
        ...
        self.load_markets(Value::Undefined, Value::Undefined).await;
        let mut name: Value = Value::from("user");
        return <Self as Coinbase>::un_subscribe(self, Value::from("orders"), name.clone(), Value::from(true), self.symbol(symbol.clone())).await;
    }
    ...
    async fn watch_order_book(&mut self, mut symbol: Value, mut limit: Value, mut params: Value) -> Value {
        ...
        let mut orderbook: Value = <Self as Coinbase>::subscribe(self, name.clone(), Value::from(false), symbol.clone(), params.clone()).await;
    ...
    async fn un_watch_order_book(&mut self, mut symbol: Value, mut params: Value) -> Value {
        ...
        symbol = self.symbol(symbol.clone());
        let mut name: Value = Value::from("level2");
        return <Self as Coinbase>::un_subscribe(self, Value::from("orderbook"), name.clone(), Value::from(false), symbol.clone()).await;
    }
    ...
    async fn watch_order_book_for_symbols(&mut self, mut symbols: Value, mut limit: Value, mut params: Value) -> Value {
        ...
        self.load_markets(Value::Undefined, Value::Undefined).await;
        let mut name: Value = Value::from("level2");
        let mut orderbook: Value = <Self as Coinbase>::subscribe_multiple(self, name.clone(), Value::from(false), symbols.clone(), params.clone()).await;
        return orderbook.limit();
    }
    ...
    fn handle_order_book_helper(&mut self, mut orderbook: Value, mut updates: Value) -> Value {
        ...
        while i < updates.len() {
            ...
            let mut orderbook_side: Value = orderbook.get(side.clone().clone());
    ...
    fn handle_order_book(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        while i < events.len() {
            ...
            if !self.get("orderbooks".into()).contains_key(symbol.clone()) && self.get("orderbooks".into()).get(symbol.clone().clone()).is_nullish() {
                continue;
            };
    ...
    fn try_resolve_usdc(&mut self, mut client: Value, mut message_hash: Value, mut result: Value) -> Value {
        if message_hash.ends_with(Value::from("/USD")) || message_hash.ends_with(Value::from("-USD")) {
    ...
    fn handle_subscription_status(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        if is_unsub.is_truthy() && sub_keys_length == Value::from(0) {
    ...
    fn handle_message(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        if r#type.clone() == Value::from("error") {
            ...
            panic!("{}", r###"ExchangeError::new(error_message.clone())"###);
        };
