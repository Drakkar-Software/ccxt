...
async fn watch_public(&mut self, mut message_hashes: Value, mut channels: Value, mut params: Value, mut subscription: Value) -> Value { Value::Undefined }

async fn watch_private(&mut self, mut message_hashes: Value, mut params: Value) -> Value { Value::Undefined }
...
fn get_message_hashes_for_tickers_unsubscription(&mut self) -> Value { Value::Undefined }
...
fn parse_ws_position_side(&self, mut raw_position_side: Value) -> Value { Value::Undefined }

async fn watch_balance(&mut self, mut params: Value) -> Value { Value::Undefined }

fn fetch_balance_snapshot(&mut self, mut client: Value) -> Value { Value::Undefined }

async fn load_balance_snapshot(&mut self, mut client: Value, mut message_hash: Value) -> Value { Value::Undefined }
