...
pub trait Exmo : Exchange {
    ...
    fn parse_spot_balance(&mut self, mut message: Value) -> Value {
        //
        //     {
        //         "balances": {
        //             "BTC": "3",
    ...
    fn parse_margin_balance(&mut self, mut message: Value) -> Value {
        //
        //     {
        //         "RUB": {
        //             "balance": "1000000",
    ...
    fn handle_my_trades(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        while j < trades.len() {
            ...
            symbols.set(trade.get(Value::from("symbol")), Value::from(true));
            j += 1;
        };
    ...
    fn handle_orders(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        while j < raw_orders.len() {
            ...
            symbols.set(order.get(Value::from("symbol")), Value::from(true));
            j += 1;
        };
        let mut symbol_keys: Value = symbols.clone().keys();
        let mut i: usize = 0;
