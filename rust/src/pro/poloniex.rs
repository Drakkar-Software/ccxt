...
async fn subscribe(&mut self, mut name: Value, mut message_hash: Value, mut is_private: Value, mut symbols: Value, mut params: Value) -> Value { Value::Undefined }
...
fn parse_ws_balance(&self, mut response: Value) -> Value { Value::Undefined }

fn handle_my_trades(&mut self, mut client: Value, mut parsed_trade: Value) -> Value { Value::Undefined }

fn handle_pong(&mut self, mut client: Value) -> Value { Value::Undefined }
