...
pub trait Hashkey : Exchange {
    ...
    fn get_private_url(&self, mut listen_key: Value) -> Value {
    ...
    fn parse_ws_order(&self, mut order: Value, mut market: Value) -> Value {
        ...
        (r#type, time_in_force, post_only) = shift_3(self.parse_order_type_time_in_force_and_post_only(r#type.clone(), time_in_force.clone(), Value::Undefined));
    ...
    async fn watch_balance(&mut self, mut params: Value) -> Value {
        ...
        (fetch_balance_snapshot, params) = shift_2(self.handle_option_and_params(self.get("options".into()), Value::from("watchBalance"), Value::from("fetchBalanceSnapshot"), Value::from(true)));
        (await_balance_snapshot, params) = shift_2(self.handle_option_and_params(self.get("options".into()), Value::from("watchBalance"), Value::from("awaitBalanceSnapshot"), Value::from(false)));
