...
fn handle_ws_tickers(&mut self, mut client: Value, mut message: Value) -> Value { Value::Undefined }

fn parse_ws_ticker(&self, mut raw_ticker: Value, mut market: Value) -> Value { Value::Undefined }
...
fn handle_ws_post(&mut self, mut client: Value, mut message: Value) -> Value { Value::Undefined }
...
fn handle_order_book_unsubscription(&mut self, mut client: Value, mut subscription: Value) -> Value { Value::Undefined }

fn handle_trades_unsubscription(&mut self, mut client: Value, mut subscription: Value) -> Value { Value::Undefined }

fn handle_tickers_unsubscription(&mut self, mut client: Value, mut subscription: Value) -> Value { Value::Undefined }

fn handle_ohlcv_unsubscription(&mut self, mut client: Value, mut subscription: Value) -> Value { Value::Undefined }

fn handle_order_unsubscription(&mut self, mut client: Value, mut subscription: Value) -> Value { Value::Undefined }

fn handle_my_trades_unsubscription(&mut self, mut client: Value, mut subscription: Value) -> Value { Value::Undefined }

fn handle_subscription_response(&mut self, mut client: Value, mut message: Value) -> Value { Value::Undefined }
...
fn wrap_as_post_action(&mut self, mut request: Value) -> Value { Value::Undefined }
