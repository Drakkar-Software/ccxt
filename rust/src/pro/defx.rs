...
async fn watch_public(&mut self, mut topics: Value, mut message_hashes: Value, mut params: Value) -> Value { Value::Undefined }

async fn un_watch_public(&mut self, mut topics: Value, mut message_hashes: Value, mut params: Value) -> Value { Value::Undefined }
