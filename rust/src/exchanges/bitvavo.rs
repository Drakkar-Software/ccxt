...
fn parse_currencies_custom(&self, mut currencies: Value) -> Value { Value::Undefined }
...
fn parse_trading_fees(&self, mut fees: Value, mut market: Value) -> Value { Value::Undefined }
