...
fn parse_time_in_force(&self, mut r#type: Value) -> Value { Value::Undefined }
...
fn parse_deposit_address(&self, mut entry: Value, mut currency: Value) -> Value { Value::Undefined }
