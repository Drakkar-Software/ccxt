...
async fn handle_portfolio_and_params(&mut self, mut method_name: Value, mut params: Value) -> Value { Value::Undefined }

async fn handle_network_id_and_params(&mut self, mut currency_code: Value, mut method_name: Value, mut params: Value) -> Value { Value::Undefined }
...
fn find_default_network(&mut self, mut networks: Value) -> Value { Value::Undefined }

async fn load_currency_networks(&mut self, mut code: Value, mut params: Value) -> Value { Value::Undefined }

fn parse_networks(&self, mut networks: Value, mut params: Value) -> Value { Value::Undefined }

fn parse_network(&self, mut network: Value, mut params: Value) -> Value { Value::Undefined }
...
fn parse_currency(&self, mut currency: Value) -> Value { Value::Undefined }
...
fn safe_network(&self, mut network: Value) -> Value { Value::Undefined }
