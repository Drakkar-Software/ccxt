...
impl Exchange for WavesexchangeImpl {
    ...
    async fn fetch_ticker(&mut self, symbol: Value, params: Value) -> Value { Wavesexchange::fetch_ticker(self, symbol, params).await }
    async fn fetch_tickers(&mut self, symbols: Value, params: Value) -> Value { Wavesexchange::fetch_tickers(self, symbols, params).await }
    async fn fetch_order_book(&mut self, symbol: Value, limit: Value, params: Value) -> Value { Wavesexchange::fetch_order_book(self, symbol, limit, params).await }
    async fn fetch_ohlcv(&mut self, symbol: Value, timeframe: Value, since: Value, limit: Value, params: Value) -> Value { Wavesexchange::fetch_ohlcv(self, symbol, timeframe, since, limit, params).await }
    async fn fetch_trades(&mut self, symbol: Value, since: Value, limit: Value, params: Value) -> Value { Wavesexchange::fetch_trades(self, symbol, since, limit, params).await }
    fn parse_trade(&self, trade: Value, market: Value) -> Value { Wavesexchange::parse_trade(self, trade, market) }
    fn parse_order(&self, order: Value, market: Value) -> Value { Wavesexchange::parse_order(self, order, market) }
    fn parse_ticker(&self, ticker: Value, market: Value) -> Value { Wavesexchange::parse_ticker(self, ticker, market) }
    fn parse_transaction(&self, transaction: Value, currency: Value) -> Value { Wavesexchange::parse_transaction(self, transaction, currency) }
    fn parse_order_status(&self, status: Value) -> Value { Wavesexchange::parse_order_status(self, status) }
}
