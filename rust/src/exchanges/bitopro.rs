...
fn insert_missing_candles(&mut self, mut candles: Value, mut distance: Value, mut since: Value, mut limit: Value) -> Value { Value::Undefined }
...
fn parse_cancel_orders(&self, mut data: Value) -> Value { Value::Undefined }
