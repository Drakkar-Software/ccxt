...
async fn fetch_funding_limits(&mut self, mut codes: Value, mut params: Value) -> Value { Value::Undefined }
...
fn is_fiat(&mut self, mut currency: Value) -> Value { Value::Undefined }
