...
impl Exchange for WhitebitImpl {
    ...
    async fn fetch_ticker(&mut self, symbol: Value, params: Value) -> Value { Whitebit::fetch_ticker(self, symbol, params).await }
    async fn fetch_tickers(&mut self, symbols: Value, params: Value) -> Value { Whitebit::fetch_tickers(self, symbols, params).await }
    async fn fetch_order_book(&mut self, symbol: Value, limit: Value, params: Value) -> Value { Whitebit::fetch_order_book(self, symbol, limit, params).await }
    async fn fetch_ohlcv(&mut self, symbol: Value, timeframe: Value, since: Value, limit: Value, params: Value) -> Value { Whitebit::fetch_ohlcv(self, symbol, timeframe, since, limit, params).await }
    async fn fetch_trades(&mut self, symbol: Value, since: Value, limit: Value, params: Value) -> Value { Whitebit::fetch_trades(self, symbol, since, limit, params).await }
    async fn fetch_time(&mut self, params: Value) -> Value { Whitebit::fetch_time(self, params).await }
    async fn fetch_status(&mut self, params: Value) -> Value { Whitebit::fetch_status(self, params).await }
    fn parse_trade(&self, trade: Value, market: Value) -> Value { Whitebit::parse_trade(self, trade, market) }
    fn parse_order(&self, order: Value, market: Value) -> Value { Whitebit::parse_order(self, order, market) }
    fn parse_ticker(&self, ticker: Value, market: Value) -> Value { Whitebit::parse_ticker(self, ticker, market) }
    fn parse_position(&self, position: Value, market: Value) -> Value { Whitebit::parse_position(self, position, market) }
    fn parse_balance(&self, response: Value) -> Value { Whitebit::parse_balance(self, response) }
    fn parse_funding_rate(&self, contract: Value, market: Value) -> Value { Whitebit::parse_funding_rate(self, contract, market) }
    fn parse_market(&self, market: Value) -> Value { Whitebit::parse_market(self, market) }
    fn parse_transaction(&self, transaction: Value, currency: Value) -> Value { Whitebit::parse_transaction(self, transaction, currency) }
    fn parse_transfer(&self, transfer: Value, currency: Value) -> Value { Whitebit::parse_transfer(self, transfer, currency) }
    fn parse_deposit_address(&self, deposit_address: Value, currency: Value) -> Value { Whitebit::parse_deposit_address(self, deposit_address, currency) }
    fn parse_conversion(&self, conversion: Value, from_currency: Value, to_currency: Value) -> Value { Whitebit::parse_conversion(self, conversion, from_currency, to_currency) }
}
