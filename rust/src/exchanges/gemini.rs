...
async fn fetch_currencies_from_web(&mut self, mut params: Value) -> Value { Value::Undefined }

async fn fetch_markets(&mut self, mut params: Value) -> Value { Value::Undefined }

async fn fetch_markets_from_web(&mut self, mut params: Value) -> Value { Value::Undefined }

fn parse_market_active(&self, mut status: Value) -> Value { Value::Undefined }

async fn fetch_usdt_markets(&mut self, mut params: Value) -> Value { Value::Undefined }

async fn fetch_markets_from_api(&mut self, mut params: Value) -> Value { Value::Undefined }

fn parse_market(&self, mut response: Value) -> Value { Value::Undefined }
...
async fn fetch_ticker_v1(&mut self, mut symbol: Value, mut params: Value) -> Value { Value::Undefined }

async fn fetch_ticker_v2(&mut self, mut symbol: Value, mut params: Value) -> Value { Value::Undefined }

async fn fetch_ticker_v1_and_v2(&mut self, mut symbol: Value, mut params: Value) -> Value { Value::Undefined }
