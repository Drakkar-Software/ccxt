...
fn get_product_group_from_market(&mut self, mut market: Value) -> Value { Value::Undefined }

fn parse_trade(&self, mut trade: Value, mut market: Value) -> Value { Value::Undefined }

fn parse_taker_or_maker(&self, mut exec_type: Value) -> Value { Value::Undefined }
...
fn create_regular_order_request(&mut self, mut symbol: Value, mut r#type: Value, mut side: Value, mut amount: Value, mut price: Value, mut params: Value) -> Value { Value::Undefined }

fn create_trigger_order_request(&mut self, mut symbol: Value, mut r#type: Value, mut side: Value, mut amount: Value, mut price: Value, mut params: Value) -> Value { Value::Undefined }

fn handle_type_post_only_and_time_in_force(&mut self, mut r#type: Value, mut params: Value) -> Value { Value::Undefined }
