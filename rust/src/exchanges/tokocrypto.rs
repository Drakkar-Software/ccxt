...
impl Exchange for TokocryptoImpl {
    ...
    async fn fetch_ticker(&mut self, symbol: Value, params: Value) -> Value { Tokocrypto::fetch_ticker(self, symbol, params).await }
    async fn fetch_tickers(&mut self, symbols: Value, params: Value) -> Value { Tokocrypto::fetch_tickers(self, symbols, params).await }
    async fn fetch_order_book(&mut self, symbol: Value, limit: Value, params: Value) -> Value { Tokocrypto::fetch_order_book(self, symbol, limit, params).await }
    async fn fetch_ohlcv(&mut self, symbol: Value, timeframe: Value, since: Value, limit: Value, params: Value) -> Value { Tokocrypto::fetch_ohlcv(self, symbol, timeframe, since, limit, params).await }
    async fn fetch_trades(&mut self, symbol: Value, since: Value, limit: Value, params: Value) -> Value { Tokocrypto::fetch_trades(self, symbol, since, limit, params).await }
    async fn fetch_time(&mut self, params: Value) -> Value { Tokocrypto::fetch_time(self, params).await }
    async fn fetch_bids_asks(&mut self, symbols: Value, params: Value) -> Value { Tokocrypto::fetch_bids_asks(self, symbols, params).await }
    fn parse_trade(&self, trade: Value, market: Value) -> Value { Tokocrypto::parse_trade(self, trade, market) }
    fn parse_order(&self, order: Value, market: Value) -> Value { Tokocrypto::parse_order(self, order, market) }
    fn parse_ticker(&self, ticker: Value, market: Value) -> Value { Tokocrypto::parse_ticker(self, ticker, market) }
    fn parse_transaction(&self, transaction: Value, currency: Value) -> Value { Tokocrypto::parse_transaction(self, transaction, currency) }
    fn parse_order_status(&self, status: Value) -> Value { Tokocrypto::parse_order_status(self, status) }
}
