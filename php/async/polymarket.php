...
class polymarket extends Exchange {
    ...
    public function fetch_markets($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            $firstResponse = Async\await($this->gamma_public_get_markets($this->extend(array(), $request, array( 'offset' => 0 ))));
            ...
            if (strlen($firstPage) >= $limit) {
                ...
                for ($round = 0; $round < $MAX_ROUNDS; $round++) {
                    ...
                    $batchResponses = Async\await(Promise\all($batchPromises));
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->clob_public_get_orderbook_token_id($this->extend($request, $params)));
    ...
    public function fetch_order_books(?array $symbols = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $limit, $params) {
            ...
            $response = Async\await($this->clob_public_post_books($this->extend(array( 'requests' => $requestBody ), $params)));
    ...
    public function fetch_ticker(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            $pricesResponse = Async\await($this->clob_public_post_prices($this->extend(array(
                'requests' => array(
            ...
            $midpoint = null;
            try {
                $midpointResponse = Async\await($this->clob_public_get_midpoint($this->extend(array( 'token_id' => $tokenId ), $params)));
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            while ($batchStart < strlen($tokenIds)) {
                ...
                $batchResponse = Async\await($this->clob_public_post_prices(array( 'requests' => $batchRequests )));
    ...
    public function parse_ticker(array $ticker, ?array $market = null): array {
        return Async\async(function () use ($ticker, $market) {
            /**
             ...
             * $ohlcv = Async\await(exchange.fetchOHLCV($symbol, '1h', $since24h, null, array(token_id => $tokenId)));
             * if (strlen($ohlcv) > 0) {
             ...
             * $trades = Async\await(exchange.fetchTrades($symbol, $since24h, null, array(token_id => $tokenId)));
             * if (strlen($trades) > 0) {
             *     $totalCost = 0;
             *     $totalVolume = 0;
             ...
             * $orderbook = Async\await(exchange.fetchOrderBook($symbol, null, array(token_id => $tokenId)));
             * $bidVolume = 0;
             * $askVolume = 0;
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->data_public_get_trades($this->extend($request, $this->omit($params, array( 'offset', 'takerOnly', 'side' )))));
            $tradesData = array();
            if ((gettype($response) === 'array' && array_keys($response) === array_keys(array_keys($response)))) {
                $tradesData = $response;
            } else {
    ...
    public function fetch_ohlcv(string $symbol, string $timeframe = '1h', ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $timeframe, $since, $limit, $params) {
            ...
            $response = Async\await($this->clob_public_get_prices_history($this->extend($request, $remainingParams)));
            $ohlcvData = array();
            if ((gettype($response) === 'array' && array_keys($response) === array_keys(array_keys($response)))) {
                $ohlcvData = $response;
            } else {
    ...
    public function build_and_sign_order(string $tokenId, string $side, string $size, ?string $price = null, ?array $market = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($tokenId, $side, $size, $price, $market, $params) {
            /**
            ...
            if ($negRisk === null && $tokenId !== null) {
                ...
                $negRiskResponse = Async\await($this->clob_public_get_neg_risk(array( 'token_id' => $tokenId )));
    ...
    public function build_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            $signedOrder = Async\await($this->build_and_sign_order($tokenId, $polymarketSide, $size, $priceStr, $market, $orderParams));
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            Async\await($this->ensure_api_credentials($params));
            // Build the $order request payload
            $requestPayload = Async\await($this->build_order($symbol, $type, $side, $amount, $price, $params));
            ...
            $response = Async\await($this->clob_private_post_order($this->extend($requestPayload, $params)));
            // Response format:
            // {
            //     "success" => boolean,
    ...
    public function create_orders(array $orders, $params = array ()): PromiseInterface {
        return Async\async(function () use ($orders, $params) {
            ...
            for ($i = 0; $i < count($orders); $i++) {
                ...
                $orderRequest = Async\await($this->build_order($symbol, $type, $side, $amount, $price, $mergedParams));
            ...
            $response = Async\await($this->clob_private_post_orders($this->extend(array( 'orders' => $orderRequests ), $params)));
    ...
    public function create_market_order(string $symbol, string $side, float $amount, ?float $price = null, $params = array ()) {
        return Async\async(function () use ($symbol, $side, $amount, $price, $params) {
            ...
            return Async\await($this->create_order($symbol, 'market', $side, $amount, $price, $this->extend($params, array( 'timeInForce' => 'IOC' ))));
        }) ();
    }
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            // See https://docs.polymarket.com/developers/CLOB/orders/cancel-order
            $response = Async\await($this->clob_private_delete_order($this->extend(array( 'order_id' => $id ), $params)));
    ...
    public function cancel_orders(array $ids, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($ids, $symbol, $params) {
            ...
            // Response format => array( $canceled => stringarray(), not_canceled => array( order_id -> reason ) )
            // See https://docs.polymarket.com/developers/CLOB/orders/cancel-order-batch
            $response = Async\await($this->clob_private_delete_orders($this->extend(array( 'order_ids' => $ids ), $params)));
            $canceled = $this->safe_list($response, 'canceled', array());
            $notCanceled = $this->safe_dict($response, 'not_canceled', array());
            $market = $symbol ? $this->market($symbol) : null;
    ...
    public function cancel_all_orders(?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            if ($symbol !== null) {
                ...
                // Response format => array( $canceled => stringarray(), not_canceled => array( order_id -> reason ) )
                $response = Async\await($this->clob_private_delete_cancel_market_orders($this->extend($request, $params)));
            } else {
                ...
                // Response format => array( $canceled => stringarray(), not_canceled => array( order_id -> reason ) )
                // See https://docs.polymarket.com/developers/CLOB/orders/cancel-all-$orders
                $response = Async\await($this->clob_private_delete_cancel_all($params));
            }
            $canceled = $this->safe_list($response, 'canceled', array());
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->clob_private_get_order($this->extend(array( 'order_id' => $id ), $params)));
            $market = $symbol ? $this->market($symbol) : null;
    ...
    public function fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            while (true) {
                $response = Async\await($this->clob_private_get_orders($this->extend($request, array( 'next_cursor' => $nextCursor ), $params)));
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->get_user_positions($userAddress, $params));
    ...
    public function fetch_user_positions(string $userId, ?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($userId, $symbols, $params) {
            /**
             * fetches the current user $positions
             ...
             */
            Async\await($this->load_markets());
            $response = Async\await($this->get_user_positions($userId, $params));
            // Response format => array of position objects
            // {
            //   "proxyWallet" => "0x...",
            //   "asset" => "0x...",
    ...
    public function fetch_closed_positions(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            /**
            ...
            Async\await($this->load_markets());
            $userAddress = $this->safe_string($params, 'userAddress');
            $response = Async\await($this->get_user_closed_positions($userAddress, $params));
            // Response format => array of position objects
            // {
            //   "proxyWallet" => "0x...",
            //   "asset" => "0x...",
    ...
    public function fetch_user_closed_positions(string $userId, ?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($userId, $symbols, $params) {
            /**
             * fetches the closed user $positions
             * @param {string} $userId user ID
             ...
             */
            Async\await($this->load_markets());
            $response = Async\await($this->get_user_closed_positions($userId, $params));
            // Response format => array of position objects
            // {
            //   "proxyWallet" => "0x...",
            //   "asset" => "0x...",
    ...
    public function fetch_time($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            // See https://github.com/Polymarket/py-clob-client/blob/main/py_clob_client/client.py#L178
            $response = Async\await($this->clob_public_get_time($params));
    ...
    public function fetch_status($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // See https://github.com/Polymarket/py-clob-client/blob/main/py_clob_client/client.py#L170
            try {
                Async\await($this->clob_public_get_ok($params));
                return array(
                    'status' => 'ok',
                    'updated' => null,
                    'eta' => null,
    ...
    public function fetch_trading_fee(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            // See https://github.com/Polymarket/py-clob-client/blob/main/py_clob_client/client.py
            $response = Async\await($this->clob_public_get_fee_rate($this->extend(array( 'token_id' => $tokenId ), $params)));
    ...
    public function fetch_open_interest(string $symbol, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = Async\await($this->data_public_get_open_interest($this->extend($request, $params)));
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            while ($next_cursor !== $endCursor) {
                $response = Async\await($this->clob_private_get_trades($this->extend($request, array( 'next_cursor' => $next_cursor ), $params)));
    ...
    public function fetch_user_trades(string $user, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($user, $symbol, $since, $limit, $params) {
            /**
            ...
            $response = Async\await($this->data_public_get_trades($this->extend($request, $this->omit($params, array( 'market', 'eventId', 'offset', 'takerOnly', 'side' )))));
            $tradesData = array();
            if ((gettype($response) === 'array' && array_keys($response) === array_keys(array_keys($response)))) {
                $tradesData = $response;
            } else {
    ...
    public function fetch_balance($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $clobResponse = Async\await($this->clob_private_get_balance_allowance($request));
            //
            //     {
            //         "balance" => "1000000",
            //         "allowance" => "0"
    ...
    public function get_notifications($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // See https://github.com/Polymarket/py-clob-client/blob/main/py_clob_client/client.py
            $response = Async\await($this->clob_private_get_notifications($this->extend($request, $params)));
            return $response;
        }) ();
    }
    ...
    public function drop_notifications($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // See https://github.com/Polymarket/py-clob-client/blob/main/py_clob_client/client.py
            $response = Async\await($this->clob_private_delete_notifications($this->extend($request, $params)));
            return $response;
        }) ();
    }
    ...
    public function get_balance_allowance($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->clob_private_get_balance_allowance($params));
        }) ();
    }
    ...
    public function update_balance_allowance($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->clob_private_put_balance_allowance($params));
            return $response;
        }) ();
    }
    ...
    public function is_order_scoring($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->clob_private_get_is_order_scoring($params));
    ...
    public function are_orders_scoring($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->clob_private_post_are_orders_scoring($this->extend(array( 'orderIds' => $orderIds ), $params)));
    ...
    public function clob_public_get_markets($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('markets', array( 'clob', 'public' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function gamma_public_get_markets($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // The api parameter should be an array [api_type, access_level] for exchanges with multiple API types
            return Async\await($this->request('markets', array( 'gamma', 'public' ), 'GET', $this->extend(array( 'api_type' => 'gamma' ), $params)));
        }) ();
    }
    ...
    public function gamma_public_get_markets_id($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request($path, array( 'gamma', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function gamma_public_get_events($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('events', array( 'gamma', 'public' ), 'GET', $this->extend(array( 'api_type' => 'gamma' ), $params)));
        }) ();
    }
    ...
    public function gamma_public_get_series($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('series', array( 'gamma', 'public' ), 'GET', $this->extend(array( 'api_type' => 'gamma' ), $params)));
        }) ();
    }
    ...
    public function gamma_public_get_search($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('search', array( 'gamma', 'public' ), 'GET', $this->extend(array( 'api_type' => 'gamma' ), $params)));
        }) ();
    }
    ...
    public function gamma_public_get_comments($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('comments', array( 'gamma', 'public' ), 'GET', $this->extend(array( 'api_type' => 'gamma' ), $params)));
        }) ();
    }
    ...
    public function gamma_public_get_sports($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('sports', array( 'gamma', 'public' ), 'GET', $this->extend(array( 'api_type' => 'gamma' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_positions($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('positions', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_trades($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('trades', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_activity($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('activity', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_holders($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('holders', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_total_value($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('value', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_closed_positions($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('closed-positions', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_traded($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('traded', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function data_public_get_open_interest($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('oi', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $requestParams)));
        }) ();
    }
    ...
    public function data_public_get_live_volume($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('live-volume', array( 'data', 'public' ), 'GET', $this->extend(array( 'api_type' => 'data' ), $params)));
        }) ();
    }
    ...
    public function bridge_public_get_supported_assets($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('supported-assets', array( 'bridge', 'public' ), 'GET', $this->extend(array( 'api_type' => 'bridge' ), $params)));
        }) ();
    }
    ...
    public function bridge_public_post_deposit($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('deposit', array( 'bridge', 'public' ), 'POST', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function create_deposit_address(string $code, $params = array ()) {
        return Async\async(function () use ($code, $params) {
            ...
            $response = Async\await($this->bridge_public_post_deposit($this->extend(array( 'address' => $address ), $params)));
    ...
    public function clob_public_get_orderbook_token_id($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('book', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_post_books($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('books', array( 'clob', 'public' ), 'POST', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function clob_public_get_market_trades_events($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('trades', array( 'clob', 'public' ), 'GET', $finalParams));
        }) ();
    }
    ...
    public function clob_public_get_prices_history($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('prices-history', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_time($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('time', array( 'clob', 'public' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_public_get_ok($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // Based on get_ok() from py-clob-client
            // See https://github.com/Polymarket/py-clob-client/blob/main/py_clob_client/client.py#L170
            return Async\await($this->request('', array( 'clob', 'public' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_public_get_fee_rate($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('fee-rate', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_price($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // See https://docs.polymarket.com/api-reference/pricing/get-market-price
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('price', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_prices($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('prices', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_post_prices($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $body = $this->json($requests);
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $this->omit($params, 'requests'));
            return Async\await($this->request('prices', array( 'clob', 'public' ), 'POST', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function clob_public_get_midpoint($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // See https://docs.polymarket.com/api-reference/pricing/get-midpoint-price
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('midpoint', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_midpoints($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('midpoints', array( 'clob', 'public' ), 'POST', $remainingParams, null, $this->json($body)));
        }) ();
    }
    ...
    public function clob_public_get_spread($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // See https://docs.polymarket.com/api-reference/spreads/get-bid-ask-spread
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('spread', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_last_trade_price($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            // See https://docs.polymarket.com/api-reference/trades/get-last-trade-price
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('last-trade-price', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_last_trades_prices($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $this->omit($params, 'token_ids'));
            return Async\await($this->request('last-trades-prices', array( 'clob', 'public' ), 'POST', $remainingParams, null, $this->json($body)));
        }) ();
    }
    ...
    public function clob_public_get_trades($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('trades', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_tick_size($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('tick-size', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_get_neg_risk($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $params);
            return Async\await($this->request('neg-risk', array( 'clob', 'public' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_public_post_spreads($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $remainingParams = $this->extend(array( 'api_type' => 'clob' ), $this->omit($params, 'token_ids'));
            return Async\await($this->request('spreads', array( 'clob', 'public' ), 'POST', $remainingParams, null, $this->json($body)));
        }) ();
    }
    ...
    public function clob_private_get_order($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request($path, array( 'clob', 'private' ), 'GET', $remainingParams));
        }) ();
    }
    ...
    public function clob_private_get_orders($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('data/orders', array( 'clob', 'private' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_private_post_order($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('order', array( 'clob', 'private' ), 'POST', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function clob_private_post_orders($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('orders', array( 'clob', 'private' ), 'POST', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function clob_private_delete_order($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('order', array( 'clob', 'private' ), 'DELETE', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function clob_private_delete_orders($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('orders', array( 'clob', 'private' ), 'DELETE', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function clob_private_delete_cancel_all($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('cancel-all', array( 'clob', 'private' ), 'DELETE', array( 'api_type' => 'clob' ), null, $body));
        }) ();
    }
    ...
    public function clob_private_delete_cancel_market_orders($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $body = $this->json($request);
            return Async\await($this->request('cancel-$market-orders', array( 'clob', 'private' ), 'DELETE', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function clob_private_get_trades($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('trades', array( 'clob', 'private' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_private_get_builder_trades($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('builder-trades', array( 'clob', 'private' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_private_get_notifications($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('notifications', array( 'clob', 'private' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_private_delete_notifications($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('notifications', array( 'clob', 'private' ), 'DELETE', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_private_get_balance_allowance($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             * @return {array} response from the exchange
             */
            return Async\await($this->request('balance-allowance', array( 'clob', 'private' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_private_put_balance_allowance($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             */
            $body = $this->json($params);
            return Async\await($this->request('balance-allowance', array( 'clob', 'private' ), 'PUT', array( 'api_type' => 'clob' ), null, $body));
        }) ();
    }
    ...
    public function clob_private_get_is_order_scoring($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('order-scoring', array( 'clob', 'private' ), 'GET', $this->extend(array( 'api_type' => 'clob' ), $params)));
        }) ();
    }
    ...
    public function clob_private_post_are_orders_scoring($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            return Async\await($this->request('orders-scoring', array( 'clob', 'private' ), 'POST', $remainingParams, null, $body));
        }) ();
    }
    ...
    public function get_user_total_value(?string $userAddress = null): PromiseInterface {
        return Async\async(function () use ($userAddress) {
            /**
             * fetches total value of a user's positions from Data-API
             *
             * @see https://docs.polymarket.com/api-reference/core/get-total-value-of-a-users-positions
            ...
            $valueResponse = Async\await($this->data_public_get_total_value(array( 'user' => $address )));
    ...
    public function get_user_positions(?string $userAddress = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($userAddress, $params) {
            /**
            ...
            return Async\await($this->data_public_get_positions($this->extend(array( 'user' => $address ), $params)));
        }) ();
    }

    public function get_user_closed_positions(?string $userAddress = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($userAddress, $params) {
            /**
            ...
            return Async\await($this->data_public_get_closed_positions($this->extend(array( 'user' => $address ), $params)));
        }) ();
    }

    public function get_user_activity(?string $userAddress = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($userAddress, $params) {
            /**
            ...
            return Async\await($this->data_public_get_activity($this->extend($request, $this->omit($params, array( 'user' )))));
        }) ();
    }
    ...
    public function create_api_key($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->fetch($url, 'POST', $headers, null));
    ...
    public function derive_api_key($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->fetch($url, 'GET', $headers, null));
            return $this->parse_api_credentials($response);
        }) ();
    }

    public function create_or_derive_api_creds($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            /**
            ...
            try {
                return Async\await($this->create_api_key($params));
            } catch (Exception $e) {
                // If create fails ($e->g., key already exists), try to derive it
                return Async\await($this->derive_api_key($params));
            }
        }) ();
    }
    ...
    public function ensure_api_credentials($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            /**
            ...
            $creds = Async\await($this->create_or_derive_api_creds($params));
