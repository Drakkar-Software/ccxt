...
export default class ob_simpleswap extends simpleswap {
    describe (): any {
    ...
    /**
     * @method
     * @name ob_simpleswap#obLoadMarketsForSymbols
    ...
    parseOrder (order: Dict, market: Market = undefined): Order {
        ...
        this.adaptSimpleswapAddressFrom (parsed);
        this.ensureSimpleswapFee (parsed);
        return parsed as Order;
    }

    parseTicker (ticker: Dict, market: Market = undefined): Ticker {
        const parsed = super.parseTicker (ticker, market) as Dict;
        this.ensureSimpleswapTickerTimestamp (parsed);
        return parsed as Ticker;
    }

    adaptSimpleswapAddressFrom (parsed: Dict): Dict {
        const info = this.safeDict (parsed, 'info', {});
        const addressFrom = this.safeString (info, 'addressFrom');
    ...
    ensureSimpleswapFee (parsed: Dict): Dict {
    ...
    ensureSimpleswapTickerTimestamp (parsed: Dict): Dict {
