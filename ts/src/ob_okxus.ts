    ...
    parseOrder (order: Dict, market: Market = undefined): Order {
        ...
        if (type !== 'market' && type !== 'limit') {
            ...
            if (slTrigger !== undefined && tpTrigger !== undefined) {
                ...
                this.log ('ob_okxus.parseOrder', 'Unsupported OKX OCO (stop loss & take profit in a single order): ' + this.json (parsed));
                updated = 'unsupported';
                ...
                this.log ('ob_okxus.parseOrder', 'Unknown ob_okxus order type, order: ' + this.json (parsed));
            }
